...
void GLWidget::paintGL()
{
    ...
    // Setting the texture id for each sampler
    GLint tex_loc;
    ...
    glUniform2f(resolution_loc, 128, 128);



    glEnable(GL_TEXTURE_RECTANGLE_ARB);

    // Binding each texture to an id
